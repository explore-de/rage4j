...
public class RougeScoreEvaluator implements Evaluator
{
	...
	public Evaluation evaluate(Sample sample)
	{
		if (!sample.hasAnswer())
		{
			throw new IllegalArgumentException("Sample must have an answer for ROUGE Score evaluation");
		}
		if (!sample.hasGroundTruth())
		{
			throw new IllegalArgumentException("Sample must have a ground truth for ROUGE Score evaluation");
		}
